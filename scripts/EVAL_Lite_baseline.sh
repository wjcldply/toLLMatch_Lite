        ...
        for K in 1; do
            for MIN_READ_TIME in 1.4; do
                simuleval \
                    ...
                    --agent s2tt_agent.py \
                    --k $K \
                    --output ONLINE_TARGETS/baseline_${0}_${ID}_${TGT_LANG}_w_Background \
                    --start-index 0 \
                    --end-index $END_INDEX \
                    --verbose \
                    --dir en-$TGT_LANG \
                ...
                simuleval \
                    ...
                    --agent s2tt_agent.py \
                    --k $K \
                    --output ONLINE_TARGETS/baseline_${0}_${ID}_${TGT_LANG}_wo_Background \
                    --start-index 0 \
                    --end-index $END_INDEX \
                    --verbose \
                    --dir en-$TGT_LANG \
